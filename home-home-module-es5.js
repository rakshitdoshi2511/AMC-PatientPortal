      ...
      _createClass(HomePage, [{
        ...
        value: function ionViewDidEnter() {
          this.tiles.push({
            id: 1,
            title: 'Laboratory',
            subtitle: 'Access to the laboratory reports',
            icon: 'icon-flask.svg',
            "class": '',
            pendingDocuments: '',
            lastDate: ''
            ...
            id: 2,
            title: 'Nutrition',
            subtitle: 'Access to the nutrition care reports',
            icon: 'icon-nutrition.svg',
            "class": '',
            pendingDocuments: '',
            lastDate: ''
          }, {
            id: 3,
            title: 'Radiology',
            subtitle: 'Access to the radiology reports and images',
            icon: 'icon-radiology.svg',
            "class": '',
            pendingDocuments: '',
            lastDate: ''
          }, {
            ...
            subtitle: 'Access General Medical Reports, ER and Hospital Discharge reports',
